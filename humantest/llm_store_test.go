...
// memoryLLMStore is a test-only executable model for the reusable public
// suite. It intentionally favors direct semantic code over a physical schema.
...
func newMemoryLLMStore() *memoryLLMStore {
	return &memoryLLMStore{state: newMemoryLLMState()}
}
